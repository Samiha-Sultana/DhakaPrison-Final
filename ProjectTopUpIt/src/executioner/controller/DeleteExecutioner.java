...
/**
 * Servlet implementation class DeleteExecutioner
 */
@WebServlet("/DeleteExecutioner")
public class DeleteExecutioner extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteExecutioner() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int update=sdao.deletePrisonerExecution(prisonersExecutioner);
		pw.println("<center><h2>"+update+" Executioner Record Deleted Successfully..</h2></center>");
