...
/**
 * Servlet implementation class deletePrisonerType2
 */
@WebServlet("/deletePrisonerType2")
public class DeletePrisonerType2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeletePrisonerType2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		prisonerType2DaoImplement sdao=new prisonerType2DaoImplement(con);
		int update=sdao.deletePrisoner(prisoner);
		pw.println("<center><h2>"+update+" Prisoner Record Deleted Successfully..</h2></center>");
