...
<li class="first active"><a href="prisoner.jsp">Prisoner</a></li>
...
<form action="RetrievePrisoners">
    <input type="submit" value="Click here" />
</form>

<p>To add a new prisoner:</p>
<form action="insertPrisoners.jsp">
    <input type="submit" value="Click here" />
</form>
<p>To update prisoner's information:</p>
<form action="updatePrisoners.jsp">
    <input type="submit" value="Click here" />
</form>
<p>To delete a prisoner:</p>
<form action="deletePrisoners.jsp">
    <input type="submit" value="Click here" />
</form>
</div>
