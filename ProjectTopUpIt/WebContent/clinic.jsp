...
<li class="first active"><a href="clinic.jsp">Doctor</a></li>
...
<div id="main">
<p>To view all the Doctors:</p>
<form action="RetrieveDoctors">
    <input type="submit" value="Click here" />
</form>

<p>To add a new doctor:</p>
<form action="insertDoctors.jsp">
    <input type="submit" value="Click here" />
</form>
<p>To update doctor's information:</p>
<form action="updateDoctors.jsp">
    <input type="submit" value="Click here" />
</form>
<p>To delete a doctor:</p>
<form action="deleteDoctors.jsp">
    <input type="submit" value="Click here" />
</form>
</div>
